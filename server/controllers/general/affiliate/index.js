...
const generalGetAffiliateDataSocket = async(io, socket, user, data, callback) => {
    try {
        ...
        }).sort({ 'affiliates.generated': -1 }).limit(10).select('roblox.id username avatar rank xp stats.deposit stats.bet affiliates.generated affiliates.referrer anonymous createdAt').lean();
